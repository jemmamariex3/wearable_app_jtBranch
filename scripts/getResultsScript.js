...
####################################*/
    ...
    $("#charts").click(function() {
        window.location.href = '/~jmt9642/wearable_web/charts.php';
    });

    $("#live").click(function () {
        window.location.href = '/~jmt9642/wearable_web/live.php';
    });

    $("#playTurn").click(function()
    {
        window.location.href = '/~jmt9642/wearable_web/minesweeper/index_turn.php';
    });

    $("#play_p1_vs_p2").click(function()
    {
        window.location.href = '/~jmt9642/wearable_web/minesweeper/index_p1_vs_p2.php';
    });

    $("#play_p3_vs_p4").click(function()
    {
        window.location.href = '/~jmt9642/wearable_web/minesweeper/index_p3_vs_p4.php';
    });

    $("#play_p1_vs_p2_turn").click(function()
    {
        window.location.href = '/~jmt9642/wearable_web/minesweeper/index_p1_vs_p2_turn.php';
    });

    $("#play_p3_vs_p4_turn").click(function()
    {
        window.location.href = '/~jmt9642/wearable_web/minesweeper/index_p3_vs_p4_turn.php';
    });
    ...
    $("#playbackButton").click(function () {
        window.location.href = '/~jmt9642/wearable_web/minesweeper/php/playerGsrPlayback.php';
    });
...
#################################################*/
    ...
    function fetchAllHRData()
    {
      ...
      $.ajax({url: "/~jmt9642/wearable_web/php/getPlayers.php?func=allHR",
    ...
    function fetchAllSkinData()
    {
      ...
      $.ajax({url: "/~jmt9642/wearable_web/php/getPlayers.php?func=allSkin",
          success: function(result) {
    ...
    function fetchAllGSRData()
    {
      ...
      $.ajax({url: "/~jmt9642/wearable_web/php/getPlayers.php?func=allGSR",
          success: function(result) {
...
###################################################*/
    ...
    function fetchPlayerHR(p, resultsID)
    {
      ...
      $.ajax({url: "/~jmt9642/wearable_web/php/getPlayers.php?func=hr&player=" + p,
          success: function(result) {
    ...
    function fetchPlayerSkin(p, resultsID)
    {
      ...
      $.ajax({url: "/~jmt9642/wearable_web/php/getPlayers.php?func=skintemp&player=" + p,
          success: function(result) {
    ...
    function fetchPlayerGSR(p, resultsID)
    {
      ...
      $.ajax({url: "/~jmt9642/wearable_web/php/getPlayers.php?func=gsr&player=" + p,
          success: function(result) {
