...
//      }
  ...
  function wait()
  {
    ...
    {
      //alert("detected!");
      setTimeout("erase()", 5000); // allow repaint of score area
    }
    waitTimer = window.setTimeout(function() {wait()}, 100);
  }
