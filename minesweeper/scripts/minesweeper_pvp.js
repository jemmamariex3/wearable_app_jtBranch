...
*/
      ...
      $.ajax({url: "../php/insertGames.php?func=exposed&gameid=" + game_id + "&tileid=" + thisSquare,
          success: function(result){console.log("tile exposed");},async: false});
...
/*
        ...
        {
          $.ajax({url: "../php/insertGames.php?func=turn&gameid=" + (game_id+1) + "&total=" + total});
        }
...
*/
  ...
  function waitForTiles()
  {
    ...
    if(game_status == 0 || game_status == -1)
    {
      ...
      if(player == 1)
      {
        $.ajax({url: "../php/insertGames.php?func=quad1&gameid=" + (game_id+1) + "&rows=" + rows + "&cols=" + cols + "&gametype=2"});
        $.ajax({url: "../php/getPlayers.php?func=getGameIdQuad&player1id=1&player2id=2", 
          success: function(result) {
          game_id = result;
        },async: false});
      ...
      {
        $.ajax({url: "../php/insertGames.php?func=quad2&gameid=" + (game_id+1) + "&rows=" + rows + "&cols=" + cols + "&gametype=2"});      
        $.ajax({url: "../php/getPlayers.php?func=getGameIdQuad&player1id=1&player2id=2", 
          success: function(result) {
          game_id = result;
        },async: false});
